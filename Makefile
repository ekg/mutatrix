...
INCLUDES = -I$(VCFLIB_ROOT) -lm -L. -L$(VCFLIB_ROOT)/tabixpp/ -ltabix -std=c++0x -lz 
...
mutatrix: mutatrix.cpp split.cpp Repeats.cpp $(VCFLIB_ROOT)/src/Variant.o $(FASTAHACK_ROOT)/Fasta.o
	g++ mutatrix.cpp split.cpp Repeats.cpp $(VCFLIB_ROOT)/src/Variant.o \
